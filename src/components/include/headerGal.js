    ...
    <div>
      ...
      <div className="header-content">
        <div className="nav-bar row">
          <div className="col-lg-6 col-md-4 ">
            <img className="logo-img" style={{cursor:'pointer'}} onClick={toHome} src={logo}/>
          </div>
          <div className="col-lg-6 col-md-8 left-nav">
            <div className="link-part">
              ...
              <div className="link-con">
                <a href="#turtles" className="link-btn" style={{color:'black'}}>Undead Turtles</a>
              </div>
              <div className="link-con">
                <a href="#roadmap"p className="link-btn" style={{color:'black'}}>Roadmap</a>
              </div>
              <div className="link-con">
                <a href="#getone" className="link-btn" style={{color:'black'}}>How to Get one?</a>
              </div>
            </div>
            <div>
